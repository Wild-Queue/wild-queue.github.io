...
<div style="font-size: 125%;">
    ...
    <div style="font-size: 90%; margin: 15px 0 0 25%">
        ...
        <a id="email" href="mailto:shalagin.e.s@gmail.com">
            <i class="fa fa-envelope" style="color:black;"/>shalagin.e.s@gmail.com
        </a>
        <a id="li-link" href="https://www.linkedin.com/in/shalagin-egor/">
            <i class="fa fa-linkedin"/>shalagin-egor
        </a>
        <a href="https://github.com/Wild-Queue/">
            <i class="fa fa-github" style="color:black;"/>Wild-Queue
        </a>
        <br />
    </div>
</div>
